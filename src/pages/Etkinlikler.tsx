    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1 pt-20">
        ...
        {!loading && events.length === 0 && (
          <section className="section-padding text-center">
            <p className="text-muted-foreground text-lg">Henüz etkinlik bulunmamaktadır.</p>
            <p className="text-muted-foreground text-sm mt-2">Admin panelinden etkinlik ekleyerek başlayabilirsiniz.</p>
          </section>
        )}
