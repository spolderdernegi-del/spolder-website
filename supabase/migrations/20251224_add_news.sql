-- Create public.news table and essential policies/indexes
DO $$
BEGIN
  -- Table
  ...
  -- Temporarily allow writes broadly; will tighten to auth.uid() after Admin auth is confirmed
